...
> [!COMMENT]- Why can't I just use `shortURL` as PK?
...
> [!COMMENT]- For 10 years, 365 billion records can be stored. N = 7
...
> [!COMMENT]- But actual TinyURL service seems to always return shortURL as 8 characters. Why and how is like that?
...
> [!COMMENT]- Do we need to execute query for this? OR use Bloom Filter?
...
> [!COMMENT]- Cache is used to store the pair of (`shortUrl`, `originUrl`)
